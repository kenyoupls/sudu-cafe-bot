...
BINGSU_RECIPES = {
    ...
    "Yakult": {
        ...
        "2000ml": {"Full Cream Milk": "300g", "Whipping Cream": "100g", "Yakult": "1310g", "Condensed Milk": "60g", "Lemon Juice": "40g"},
    ...
    "Strawberry": {
        "100ml":  {"Low Fat Milk": "84.5g", "Condensed Milk": "12g", "Vanilla Extract": "2.5g", "Lime Juice": "0.9g"},
        "1000ml": {"Low Fat Milk": "845g", "Condensed Milk": "120g", "Vanilla Extract": "25g", "Lime Juice": "9g"},
        "2000ml": {"Low Fat Milk": "1690g", "Condensed Milk": "240g", "Vanilla Extract": "50g", "Lime Juice": "18g"},
        "3000ml": {"Low Fat Milk": "2535g", "Condensed Milk": "360g", "Vanilla Extract": "75g", "Lime Juice": "27g"},
        "4000ml": {"Low Fat Milk": "3380g", "Condensed Milk": "480g", "Vanilla Extract": "100g", "Lime Juice": "36g"},
    },
}
...
FOAM_RECIPES = {
    ...
    "Strawberry Drizzle": {
        "ingredients": {"Yoghurt": "20g", "Strawberry": "30g"},
...
STOCK_MINIMUMS = {
    ...
    "Full Cream Milk":        {"min": 40, "location": "Right bench"},
    "Low Fat Milk":           {"min": 40, "location": "Right bench"},
    "Condensed Milk":         {"min": 10, "location": ""},
    "Coconut Milk":           {"min": 8, "location": ""},
    "Gula Melaka Liquid":     {"min": 4, "location": ""},
    "Red Bean":               {"min": 8, "location": ""},
    ...
    "Konnyaku Powder":        {"min": 6, "location": ""},
    "Goji Berry":             {"min": 6, "location": ""},
    "Puffed Rice":            {"min": 3, "location": ""},
    "Milo Powder":            {"min": 3, "location": ""},
    "Milo Krunch":            {"min": 15, "location": ""},
    "Mini Marshmallow":       {"min": 3, "location": ""},
    "Hup Seng Biscuits":      {"min": 6, "location": ""},
    "Lotus Biscoff Crumbs":   {"min": 6, "location": ""},
    "Freeze Dried Strawberries": {"min": 1, "location": ""},
    "Strawberry Sauce":       {"min": 1, "location": ""},
    "Lychee Nata De Coco":    {"min": 10, "location": ""},
    "Lychee Popping Boba":    {"min": 10, "unit": "3kg big tub", "location": ""},
    "Mango Cordial":          {"min": 6, "location": ""},
    "Mango Nata De Coco":     {"min": 10, "location": ""},
    "Brown Boba (Jelly)":     {"min": 6, "location": ""},
    ...
    "Hot Tea":                {"min": 15, "unit": "sachets each", "location": ""},
    "Salt":                   {"min": 1, "location": ""},
    ...
    "Toilet/Floor Cleaner":   {"min": 3, "location": ""},
...
INSPECTION_CHECKLIST = {
    ...
    "Overall": [
        ...
        "8.2 Music",
        "8.3 Lighting",
        "8.4 Stock Balance and expiry check",
    ],
    "Targets": [
        "9.1 Punctuality (RM150)",
        "9.2 No Complaints",
        "9.3 Content (20/month) - Edwin",
        "9.4 KOL post(4/month) - JT",
        "9.5 Reviews (40 a month)",
    ],
}
