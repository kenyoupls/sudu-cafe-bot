...
STOCK_MINIMUMS = {
    ...
    "Agar Jelly Boba":        {"min": 4, "location": ""},
    "Blackcurrant Syrup":     {"min": 2, "location": ""},
    "Hot Tea":                {"min": 15, "unit": "sachets each", "location": ""},
    "Honey":                  {"min": 1, "location": ""},
    "Moconna Coffee":         {"min": 1, "location": ""},
    "Salt":                   {"min": 1, "location": ""},
    ...
    "Chendol":                {"min": 2, "location": "Fridge"},
    "Taro Balls":             {"min": 1, "unit": "half pack", "location": "Fridge"},
    # ─── Supplies (Outside Counter minimums) ───
    "Customer Hand Tissues":  {"min": 15, "unit": "small packs + 2 big packs", "location": "Left bench / In counter"},
    "Toilet Sink Hand Tissue": {"min": 20, "unit": "small packs", "location": ""},
    "Plastic Cup (Takeaway)": {"min": 4, "unit": "packs", "location": ""},
    "Plastic Cup Cover":      {"min": 2, "unit": "packs", "location": ""},
    "Thin Straw":             {"min": 6, "unit": "packs", "location": ""},
    "Fat Straw":              {"min": 2, "unit": "packs", "location": ""},
    "Drinks Takeaway Plastic Bag": {"min": 2, "unit": "packs", "location": ""},
    "Kitchen Rubbish Bag":    {"min": 5, "location": ""},
    ...
    "Toilet Small Rubbish Bag": {"min": 2, "location": "Back of shop"},
    "Big Toilet Roll (Round)": {"min": 4, "location": ""},
    "Toilet Cleaner":         {"min": 2, "location": ""},
    "Bleach":                 {"min": 2, "location": ""},
    "Floor Cleaner":          {"min": 3, "location": ""},
}
